...
export const Main: FC<MainProps> = ({ title = 'template next' }) => {
  return (
    <main className="flex h-screen w-full flex-col items-center justify-center gap-4 bg-zinc-100 px-4 dark:bg-zinc-800 md:flex-row lg:gap-20">
      <div className="flex flex-col items-center justify-center space-y-4 md:space-y-8">
        <h1 className="text-xl font-bold capitalize text-zinc-800 dark:text-zinc-100 md:text-4xl lg:text-6xl">
          {title}
        </h1>
      ...
      <div className="flex flex-col items-center justify-center space-y-4 md:space-y-8">
        <h4 className="text-xl font-bold capitalize text-zinc-800 dark:text-zinc-100 md:text-4xl lg:text-6xl">
          tecnologias
        </h4>

        <ul className="text-sm text-zinc-800 dark:text-zinc-100 md:space-y-2 md:text-base">
          <li>
